...
public:
    enum BaudRate {
        BR_300 = 300, BR_1200 = 1200, BR_2400 = 2400,
...
public:
     ...
     */
public:
    static void wait(long millisec);
...
public:
    bool readUntil(std::string &str, char until);
...
private:
    static SP_BAUDRATE getBaudRateInOS(BaudRate baudRate);
